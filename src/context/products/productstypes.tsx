...
export type ACTIONS_PRODUCTS = GET_DASHBOARD_PRODUCTS|GET_CATEGORIES | GET_STATUSES | CREATE_PRODUCT|GET_PUBLICATIONS_USER|GET_PUBLICATION_DATA|UPDATE_PRODUCT|DELETE_PUBLICATION
