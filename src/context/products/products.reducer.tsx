...
const productsReducer = (
  ...
  switch (action.type) {
    ...
    case PRODUCTS_ACTIONS.DELETE_PUBLICATION:
      ...
      return {
        ...state,
        publicationsUser: state.publicationsUser.filter(
          publication => publication.uuid !== datadelete.uuid
        ),
      };
    ...
    case PRODUCTS_ACTIONS.GET_RELATED_PRODUCTS:
      let datarelated = action.payload;
      return {
        ...state,
