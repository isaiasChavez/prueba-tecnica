...
import { CreateProductDTO } from "../context/products/products.dto";
import { Category, Publication } from "../context/products/productstypes";
...
const NewPublication: React.FC<NewPublicationProps> = () => {
  ...
  let {uuid} = useParams();
  const {publicationSelected} = useContext(ProductsContext)
  console.log({uuid})
  ...
  const { getCategories, getStatusesProduct, create,getPublicationData, categories, statuses } =
  ...
  const [fields, setfields] = useState({
    title:  uuid?publicationSelected.title:'',
    category: "",
    price: uuid?publicationSelected.price:0,
    status: uuid?publicationSelected.status as any:"",
    description: uuid?publicationSelected.description:'',
  });
